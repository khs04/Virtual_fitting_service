...
if __name__ == "__main__":
    ...
    for face_file in face_files:
        for cloth_file in cloth_files:
            ...
            grid.save(os.path.join(args.output_path, output_filename))
